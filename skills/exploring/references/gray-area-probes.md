...
Use these probes in Phase 2 of the exploring skill to generate gray areas for the feature.
Select 2–4 probes per domain type that apply. Do NOT use all probes — pick the ones that
are genuinely undecided for this specific feature.
...
**Delivery & Medium**
- How is this delivered — in-app, email, push notification, downloadable file, or printed?
- If email or notification: triggered by event, scheduled batch, or on-demand?
- Does each recipient get the same content, or is it personalized per user?
- Are there localization or translation requirements?
...
- Are there examples or code snippets?
...
*(Apply to any domain type when relevant — use all that apply, no selection limit. The 2–4 selection rule applies only to the domain sections above.)*
